...
<div class="page page_register">
	{include file="frontend/components/breadcrumbs.tpl" currentTitleKey="user.register"}
        ...
        <div class="ubma_preform">
        <p>{translate key="ubma.site.register.intro"}</p>
        <p>
        {translate key="ubma.site.register.newsletter"}
        {translate key="ubma.site.register.submissions"}
        {translate key="ubma.site.register.reviewer"}
        </p>
        <p>{translate key="ubma.site.register.fillform"}</p>
        </div>
	...
	<form class="cmp_form register" id="register" method="post" action="{url op="register"}">
        ...
        <div class="ubma_postform">
        <p>{translate key="ubma.site.register.privacy"}</p>
        <p>{translate key="ubma.site.register.mandatory"}</p>
        <p>{translate key="ubma.site.register.mail"}</p>
        <p>{translate key="ubma.site.register.delete"}</p>
        <p>{translate key="ubma.site.register.disclosure"}</p>
        <p>{translate key="ubma.site.register.policy"}</p>
        </div>
