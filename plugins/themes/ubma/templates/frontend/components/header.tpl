		...
		<header class="pkp_structure_head" id="headerNavigationContainer" role="banner">
			<div class="pkp_head_wrapper">
                <div class="logo_wrapper">
                    {* University Logo or site title *}
                    <div class="uni_name">
                            <a href="https://www.uni-mannheim.de/" class="is_img uni_logo">
                                <img src="{$baseUrl}/plugins/themes/ubma/templates/images/structure/unima.png" alt="University of Mannheim">
                            </a>
                    </div>

                    {* Library Logo or site title *}
                    <div class="library_name">
                            <a href="https://www.bib.uni-mannheim.de/" class="is_img ub_logo">
                                <img src="{$baseUrl}/plugins/themes/ubma/templates/images/structure/ubma.png" alt="Mannheim University Library">
                            </a>
                    </div>
                </div>
