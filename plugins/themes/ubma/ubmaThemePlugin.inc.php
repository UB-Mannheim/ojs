...
class ubmaThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('accentColour', 'colour', array(
			'label' => 'plugins.themes.ubma.option.accentColour.label',
	...
	function getDisplayName() {
		return __('plugins.themes.ubma.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.ubma.description');
	}
}
